    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="/crm/updateExecutemanageSave" method="post">
                            ...
                            <br>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"for="cause">执行操作：</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
