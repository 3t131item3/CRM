    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="/crm/updateContractCreateSave" method="post">
                            <input  name="id" value="${contractCreate.id}" class="form-control col-md-7 col-xs-12" placeholder="请输入员工编码" required="required" type="hidden">
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="userName">姓名：<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="userName"  name="userName" value="${contractCreate.userName}" class="form-control col-md-7 col-xs-12" placeholder="请输入员工编码" required="required" type="text"maxlength="30">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="contractName"  name="contractName" value="${contractCreate.contractName}" class="form-control col-md-7 col-xs-12" placeholder="请输入员工编码" required="required" type="text"maxlength="30">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="contractType" id="contractType"class="form-control">
                                        <option value="销售合同"<c:if test="${contractCreate.contractType=='销售合同'}">selected="selected"</c:if>>销售合同</option>
                                        <option value="委托合同"<c:if test="${contractCreate.contractType=='委托合同'}">selected="selected"</c:if>>委托合同</option>
                                        <option value="技术合同"<c:if test="${contractCreate.contractType=='技术合同'}">selected="selected"</c:if>>技术合同</option>
                                        <option value="运输合同"<c:if test="${contractCreate.contractType=='运输合同'}">selected="selected"</c:if>>运输合同</option>
                                    </select>
                                </div>
                            </div>
                          <div class="item form-group">
                           ...
                           <div class="item form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="form-control col-md-7 col-xs-12" name="contractContent"id="contractContent"maxlength="200" style="height: 100px" required="">${contractCreate.contractContent}</textarea>
                                </div>
                            </div>
                             <div class="form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12"for="remark">备注信息：</label>
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                   <textarea class="form-control col-md-7 col-xs-12"maxlength="200" name="remark"id="remark" style="height: 100px">${contractCreate.remark}</textarea>
                               </div>
                           </div>
