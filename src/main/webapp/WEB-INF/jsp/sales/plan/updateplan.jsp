                        ...
                        <form class="form-horizontal form-label-left" action="/crm/updatePlanSave" method="post" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="code" class="form-control col-md-7 col-xs-12"  name="code" value="${plan.code}" placeholder="请输入计划编码" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="createdBy" type="text" value="${plan.planContent}" name="createdBy"  required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
