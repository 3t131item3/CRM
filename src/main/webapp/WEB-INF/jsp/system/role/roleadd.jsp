...
<div class="right_col" role="main">
    <div class="main">
           ...
           <form id="f" class="form-horizontal form-label-left" action="/crm/addRoleSave"  method="post">
               <%--创建人默认当前session的名字--%>
               ...
               <div class="item form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text"  class="form-control col-md-7 col-xs-12" name="roleName" id="roleName" placeholder="请输入角色名称" required=""/>
                   </div>
               </div>
               <div class="item form-group">
               ...
               <div class="item form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                       <textarea  class="form-control col-md-7 col-xs-12"id="remark" name="remark" style="height: 100px"></textarea>
                   </div>
               </div>
