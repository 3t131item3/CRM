        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="/crm/updateCustomerSatisfactionSave" method="post" class="form-horizontal form-label-left" novalidate>
                            <input  class="form-control col-md-7 col-xs-12"  name="id" value="${customerSatisfaction.id}"type="hidden">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="radio" id="genderM" name="sex" class="flat" value="男"  <c:if test="${customerSatisfaction.sex=='男'}">checked</c:if> > 男
                                    <input type="radio" id="genderF" name="sex" class="flat" value="女"  <c:if test="${customerSatisfaction.sex=='女'}">checked</c:if>> 女
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="status" id="status"class="form-control">
                                        <option value="正常"<c:if test="${customerSatisfaction.status=='正常'}">selected="selected"</c:if>>正常</option>
                                        <option value="已流失"<c:if test="${customerSatisfaction.status=='已流失'}">selected="selected"</c:if>>已流失</option>
                                    </select>
                                </div>
                            </div>
                            <div class="item form-group">
